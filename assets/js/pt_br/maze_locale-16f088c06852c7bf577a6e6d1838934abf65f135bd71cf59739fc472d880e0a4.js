...
"collect":function(d){return "coletar"},
"collectiblePresent":function(d){return "existe algum tesouro"},
"collectorCollectTooltip":function(d){return "Coletar um item"},
"collectorCollectedEverything":function(d){return "Parabéns! Você coletou "+maze_locale.p(d,"count",0,"pt",{"one":maze_locale.n(d,"count")+" item","other":maze_locale.n(d,"count")+" itens"})+"!"},
"collectorCollectedNothing":function(d){return "Continue programando! Você precisa coletar o máximo de itens que puder."},
"collectorCollectedSome":function(d){return "Bom trabalho! Você coletou "+maze_locale.p(d,"count",0,"pt",{"one":maze_locale.n(d,"count")+" item","other":maze_locale.n(d,"count")+" itens"})+"!"},
"collectorCollectedNotEnough":function(d){return "Continue programando! Você precisa coletar no mínimo mais "+maze_locale.p(d,"goal",0,"pt",{"one":maze_locale.n(d,"goal")+" item","other":maze_locale.n(d,"goal")+" itens"})+"."},
"collectorCollectedTooMany":function(d){return "Esse espaço não tem itens suficientes para eu coletar."},
"collectorTooManyBlocks":function(d){return "Você só pode usar "+maze_locale.v(d,"blockLimit")+" blocos. Dê uma olhada no seu código e tente novamente!"},
"continue":function(d){return "Continuar"},
"corn":function(d){return "milho"},
"cornTooltip":function(d){return "Colher algumas espigas de milho"},
"didNotCollectAllCrops":function(d){return "Certifique-se de não deixar nenhuma colheita para trás!"},
"didNotCollectEverything":function(d){return "Certifique-se de não deixar nenhum néctar ou mel para trás!"},
"didNotPlantEverywhere":function(d){return "Certifique-se de plantar algo em todas as porções de terra!"},
...
"emptyCropError":function(d){return "Essa colheita foi toda perdida."},
...
"haslettuce":function(d){return "há alface"},
...
"lettuce":function(d){return "alface"},
"lettuceTooltip":function(d){return "Colher um pouco de alface"},
...
"pick":function(d){return "pegar"},
"pilePresent":function(d){return "houver uma pilha"},
"plant":function(d){return "plantar"},
"plantInNonSoilError":function(d){return "Só posso plantar algo em terra fresca."},
"plantTooltip":function(d){return "Plantar uma muda"},
"pumpkin":function(d){return "abóbora"},
"pumpkinTooltip":function(d){return "Colher uma abóbora"},
...
"soil":function(d){return "terra"},
"sprout":function(d){return "muda"},
...
"wrongCropError":function(d){return "Não posso colher aqui."},
